...
export const metadata = {
  title: 'Mahdi Fazeli | Personal Portfolio',
  description: 'Mahdi Fazeli is a full stack web enthusiastic and professional and developer with handfull kowledge in web and software development',
}
